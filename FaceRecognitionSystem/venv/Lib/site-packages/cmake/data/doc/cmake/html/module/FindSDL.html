...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindSDL &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindSDL_sound.html" title="FindSDL_sound" accesskey="N"
            >next</a
          >
          |
        </li>
        <li class="right">
          <a href="FindSDL_net.html" title="FindSDL_net" accesskey="P"
            >previous</a
          >
          |
        </li>
          ...
          <div class="body" role="main">
            <div class="section" id="findsdl">
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>SDL_LIBRARY, the name of the library to link against
...
SDL_VERSION_STRING, human-readable string containing the version of SDL
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>SDL_BUILDING_LIBRARY
  ...
  as part of the returned SDL_LIBRARY variable.
              ...
              <p>
                ...
                Also for OS X, this module will automatically add the -framework
              ...
              <p>
                ...
                #include “SDL.h”, not &lt;SDL/SDL.h&gt;. This is done for
                portability reasons because not all systems place things in SDL/
                (see FreeBSD).
              </p>
            </div>
          </div>
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindSDL_net.html" title="previous chapter">FindSDL_net</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindSDL_sound.html" title="next chapter">FindSDL_sound</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindSDL.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindSDL_sound.html" title="FindSDL_sound">next</a> |
        </li>
        <li class="right">
          <a href="FindSDL_net.html" title="FindSDL_net">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
