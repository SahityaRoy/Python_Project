...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Findosg &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgShadow.html" title="FindosgShadow" accesskey="N"
            >next</a
          >
          |
        </li>
        <li class="right">
          <a href="FindosgQt.html" title="FindosgQt" accesskey="P">previous</a>
          |
        </li>
        <li>
          <img
    ...
    <div class="document">
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgQt.html" title="previous chapter">FindosgQt</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgShadow.html" title="next chapter">FindosgShadow</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/Findosg.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgShadow.html" title="FindosgShadow">next</a> |
        </li>
        <li class="right">
          <a href="FindosgQt.html" title="FindosgQt">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
