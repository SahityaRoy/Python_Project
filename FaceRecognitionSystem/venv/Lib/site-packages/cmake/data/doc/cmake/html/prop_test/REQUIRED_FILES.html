...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>REQUIRED_FILES &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="RESOURCE_GROUPS.html" title="RESOURCE_GROUPS" accesskey="N"
            >next</a
          >
          |
        </li>
        <li class="right">
          <a href="PROCESSORS.html" title="PROCESSORS" accesskey="P"
            >previous</a
          >
          |
        </li>
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="required-files">
              <span id="prop_test:REQUIRED_FILES"></span>
              <h1>
                REQUIRED_FILES<a
                  class="headerlink"
                  href="#required-files"
              ...
              <p>
                ...
                ><a
                  ...
                  href="WORKING_DIRECTORY.html#prop_test:WORKING_DIRECTORY"
              ...
              <div class="section" id="examples">
                ...
                <p>
                  ...
                  <code class="docutils literal notranslate"
                    ><span class="pre">test.txt</span></code
                  >
                  is created by test
                  <code class="docutils literal notranslate"
                    ><span class="pre">baseTest</span></code
                  >
                  and
                  <code class="docutils literal notranslate"
                    ><span class="pre">none.txt</span></code
                  >
                  does not exist:
                </p>
                <div class="highlight-cmake notranslate">
                  <div class="highlight">
                    <pre><span></span><span class="nf">add_test(</span><span class="no">NAME</span><span class="w"> </span><span class="nb">baseTest</span><span class="w"> </span><span class="p">...</span><span class="nf">)</span><span class="w">   </span><span class="c"># Assumed to create test.txt</span>
...
<span class="nf">)</span><span class="w"></span>
                ...
                <p>
                  ...
                  <code class="docutils literal notranslate"
                    ><span class="pre">REQUIRED_FILES</span></code
                  >
                  works, but it is not the most robust way to implement test
                  ordering with failure detection. For that, test fixtures are a
                  better alternative (see
                  <span
                    class="target"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <ul>
            <li>
              <a class="reference internal" href="#">REQUIRED_FILES</a>
              <ul>
                <li>
          ...
          <p class="topless">
            <a href="PROCESSORS.html" title="previous chapter">PROCESSORS</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="RESOURCE_GROUPS.html" title="next chapter"
              >RESOURCE_GROUPS</a
            >
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/prop_test/REQUIRED_FILES.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="RESOURCE_GROUPS.html" title="RESOURCE_GROUPS">next</a> |
        </li>
        <li class="right">
          <a href="PROCESSORS.html" title="PROCESSORS">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
