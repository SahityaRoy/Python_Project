...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgWidget &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindPatch.html" title="FindPatch" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a href="FindosgVolume.html" title="FindosgVolume" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgwidget">
              <span id="module:FindosgWidget"></span>
              <h1>
                FindosgWidget<a
                  class="headerlink"
                  href="#findosgwidget"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgVolume.html" title="previous chapter"
              >FindosgVolume</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindPatch.html" title="next chapter">FindPatch</a>
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindosgWidget.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindPatch.html" title="FindPatch">next</a> |
        </li>
        <li class="right">
          <a href="FindosgVolume.html" title="FindosgVolume">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
