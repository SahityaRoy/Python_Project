...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgQt &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="Findosg.html" title="Findosg" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a href="FindosgProducer.html" title="FindosgProducer" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgProducer.html" title="previous chapter"
              >FindosgProducer</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="Findosg.html" title="next chapter">Findosg</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindosgQt.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right"><a href="Findosg.html" title="Findosg">next</a> |</li>
        <li class="right">
          <a href="FindosgProducer.html" title="FindosgProducer">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
