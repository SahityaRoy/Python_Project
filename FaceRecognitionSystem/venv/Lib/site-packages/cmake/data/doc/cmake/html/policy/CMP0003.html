...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>CMP0003 &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="CMP0002.html" title="CMP0002" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a href="CMP0004.html" title="CMP0004" accesskey="P">previous</a> |
        </li>
        <li>
          <img
          ...
          <div class="body" role="main">
            <div class="section" id="cmp0003">
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>target_link_libraries(myexe /path/to/libA.so)
</pre>
                </div>
              </div>
              <p>
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>target_link_libraries(myexe /path/to/libA.so B)
</pre>
                </div>
              </div>
              <p>
                ...
                is meant to find
                <code class="docutils literal notranslate"
                  ><span class="pre">/path/to/libB.so</span></code
                >. This code is wrong because the user is asking the linker to
                find library B but has not provided a linker search path (which
                may be added with the link_directories command). However, with
                the old linking implementation the code would work accidentally
              ...
              <p>
                ...
                added by linking to libraries with known full paths, the
                <code class="docutils literal notranslate"
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>... -L/path/to /path/to/libA.so -lB ...
</pre>
                </div>
              </div>
              <p>
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>... /path/to/libA.so -lB ...
</pre>
                </div>
              </div>
              ...
              <p>
                ...
                add_executable or add_library command. For the example described
                above, the code
              </p>
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>cmake_policy(SET CMP0003 OLD) # or cmake_policy(VERSION 2.4)
...
target_link_libraries(myexe /path/to/libA.so B)
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>cmake_policy(SET CMP0003 NEW) # or cmake_policy(VERSION 2.6)
...
target_link_libraries(myexe /path/to/libA.so B)
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>add_executable(myexe myexe.c)
target_link_libraries(myexe /path/to/libA.so /path/to/libB.so)
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="CMP0004.html" title="previous chapter">CMP0004</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="CMP0002.html" title="next chapter">CMP0002</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/policy/CMP0003.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right"><a href="CMP0002.html" title="CMP0002">next</a> |</li>
        <li class="right">
          <a href="CMP0004.html" title="CMP0004">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
