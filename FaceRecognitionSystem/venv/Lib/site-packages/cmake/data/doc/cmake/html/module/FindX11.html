...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindX11 &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindXMLRPC.html" title="FindXMLRPC" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a href="FindXercesC.html" title="FindXercesC" accesskey="P"
            >previous</a
          >
          |
        </li>
          ...
          <div class="body" role="main">
            <div class="section" id="findx11">
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>X11_FOUND        - True if X11 is available
...
X11_LIBRARIES    - link against these to use X11
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>X11_ICE_INCLUDE_PATH,          X11_ICE_LIB,        X11_ICE_FOUND,        X11::ICE
...
X11_XSync_INCLUDE_PATH,        (in X11_Xext_LIB),  X11_XSync_FOUND
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindXercesC.html" title="previous chapter">FindXercesC</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindXMLRPC.html" title="next chapter">FindXMLRPC</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindX11.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindXMLRPC.html" title="FindXMLRPC">next</a> |
        </li>
        <li class="right">
          <a href="FindXercesC.html" title="FindXercesC">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
