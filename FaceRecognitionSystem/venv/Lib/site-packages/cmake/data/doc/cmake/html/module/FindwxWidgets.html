...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindwxWidgets &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindXCTest.html" title="FindXCTest" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a href="FindWish.html" title="FindWish" accesskey="P">previous</a> |
        </li>
        <li>
          <img
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findwxwidgets">
              <span id="module:FindwxWidgets"></span>
              <h1>
                FindwxWidgets<a
                  class="headerlink"
                  href="#findwxwidgets"
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>wxWidgets_ROOT_DIR      - Base wxWidgets directory
...
wxWidgets_EXCLUDE_COMMON_LIBRARIES
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>wxWidgets_USE_DEBUG
...
wxWidgets_USE_STATIC
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>set(wxWidgets_CONFIG_OPTIONS --toolkit=base --prefix=/usr)
</pre>
                </div>
              </div>
              <p>
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>wxWidgets_FOUND            - Set to TRUE if wxWidgets was found.
...
wxWidgets_USE_FILE         - Convenience include file.
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span># Note that for MinGW users the order of libs is important!
...
if(wxWidgets_FOUND)
  ...
  target_link_libraries(&lt;YourTarget&gt; ${wxWidgets_LIBRARIES})
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>find_package(wxWidgets REQUIRED gl core base OPTIONAL_COMPONENTS net)
include(${wxWidgets_USE_FILE})
# and for each of your dependent executable/library targets:
target_link_libraries(&lt;YourTarget&gt; ${wxWidgets_LIBRARIES})
</pre>
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindWish.html" title="previous chapter">FindWish</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindXCTest.html" title="next chapter">FindXCTest</a>
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindwxWidgets.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindXCTest.html" title="FindXCTest">next</a> |
        </li>
        <li class="right">
          <a href="FindWish.html" title="FindWish">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
