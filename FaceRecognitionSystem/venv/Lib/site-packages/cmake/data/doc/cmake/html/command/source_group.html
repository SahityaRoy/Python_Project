...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>source_group &mdash; CMake 3.18.4 Documentation</title>
    ...
    <link
      ...
      href="set_tests_properties.html"
    />
  </head>
  <body>
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="source-group">
              <span id="command:source_group"></span>
              <h1>
                source_group<a
                  class="headerlink"
                  href="#source-group"
...
<span class="nf">source_group(</span><span class="no">TREE</span><span class="w"> </span><span class="nv">&lt;root&gt;</span><span class="w"> </span><span class="p">[</span><span class="no">PREFIX</span><span class="w"> </span><span class="nv">&lt;prefix&gt;</span><span class="p">]</span><span class="w"> </span><span class="p">[</span><span class="no">FILES</span><span class="w"> </span><span class="nv">&lt;src&gt;...</span><span class="p">]</span><span class="nf">)</span><span class="w"></span>
              ...
              <p>
                ...
                files. This is intended to set up file tabs in Visual Studio.
                The options are:
              </p>
              <dl class="simple">
                <dt>
                  <code class="docutils literal notranslate"
                    ><span class="pre">TREE</span></code
                  >
                </dt>
                <dd>
                  <p>
                ...
                <dd>
                  <p>
                    Any source file whose name matches the regular expression
                    will be placed in group
                    <code class="docutils literal notranslate"
                      ><span class="pre">&lt;name&gt;</span></code
                    >.
                  </p>
              ...
              <p>
                If a source file matches multiple groups, the
                <em>last</em> group that explicitly lists the file with
                <code class="docutils literal notranslate"
                  ><span class="pre">FILES</span></code
                >
                will be favored, if any. If no group explicitly lists the file,
                the <em>last</em> group whose regular expression matches the
                file will be favored.
              </p>
              <p>
                The
                <code class="docutils literal notranslate"
                ...
                <code class="docutils literal notranslate"
                  ><span class="pre">&lt;prefix&gt;</span></code
                >
                argument may contain forward slashes or backslashes to specify
                subgroups. Backslashes need to be escaped appropriately:
              </p>
              <div class="highlight-cmake notranslate">
                <div class="highlight">
                  <pre><span></span><span class="nf">source_group(</span><span class="na">base/subdir</span><span class="w"> </span><span class="p">...</span><span class="nf">)</span><span class="w"></span>
...
<span class="nf">source_group(</span><span class="no">TREE</span><span class="w"> </span><span class="nv">&lt;root&gt;</span><span class="w"> </span><span class="no">PREFIX</span><span class="w"> </span><span class="nb">sources</span><span class="p">\\</span><span class="nb">inc</span><span class="w"> </span><span class="p">...</span><span class="nf">)</span><span class="w"></span>
              ...
              <div class="highlight-cmake notranslate">
                <div class="highlight">
                  <pre><span></span><span class="nf">source_group(</span><span class="nv">&lt;name&gt;</span><span class="w"> </span><span class="nv">&lt;regex&gt;</span><span class="nf">)</span><span class="w"></span>
</pre>
                </div>
              </div>
              ...
              <div class="highlight-cmake notranslate">
                <div class="highlight">
                  <pre><span></span><span class="nf">source_group(</span><span class="nv">&lt;name&gt;</span><span class="w"> </span><span class="no">REGULAR_EXPRESSION</span><span class="w"> </span><span class="nv">&lt;regex&gt;</span><span class="nf">)</span><span class="w"></span>
</pre>
                </div>
              </div>
            </div>
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="set_tests_properties.html" title="previous chapter"
              >set_tests_properties</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="target_compile_definitions.html" title="next chapter"
          ...
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/command/source_group.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
