...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgPresentation &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgProducer.html" title="FindosgProducer" accesskey="N"
            >next</a
          >
          |
        </li>
        <li class="right">
          <a href="FindosgParticle.html" title="FindosgParticle" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgpresentation">
              <span id="module:FindosgPresentation"></span>
              <h1>
                FindosgPresentation<a
                  class="headerlink"
                  href="#findosgpresentation"
              ...
              <p>
                ...
                OSGPRESENTATION_LIBRARIES - The libraries to link for
                osgPresentation (use this)
              </p>
              <p>
                OSGPRESENTATION_LIBRARY - The osgPresentation library
                OSGPRESENTATION_LIBRARY_DEBUG - The osgPresentation debug
                library
              </p>
              <p>
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgParticle.html" title="previous chapter"
              >FindosgParticle</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgProducer.html" title="next chapter"
              >FindosgProducer</a
            >
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindosgPresentation.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgProducer.html" title="FindosgProducer">next</a> |
        </li>
        <li class="right">
          <a href="FindosgParticle.html" title="FindosgParticle">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
