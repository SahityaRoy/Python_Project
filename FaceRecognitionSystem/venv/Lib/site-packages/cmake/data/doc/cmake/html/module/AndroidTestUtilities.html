...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>AndroidTestUtilities &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="BundleUtilities.html" title="BundleUtilities" accesskey="N"
            >next</a
          >
          |
        </li>
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="androidtestutilities">
              <span id="module:AndroidTestUtilities"></span>
              <h1>
                AndroidTestUtilities<a
                  class="headerlink"
                  href="#androidtestutilities"
                  title="Permalink to this headline"
                  >¶</a
                >
              </h1>
              <p>
                Create a test that automatically loads specified data onto an
                Android device.
              </p>
              <div class="section" id="introduction">
                ...
                <p>
                  ...
                  specified destination. The files are only uploaded if they are
                  not already in the object store.
                </p>
                <p>For example:</p>
                <div class="highlight-cmake notranslate">
                  <div class="highlight">
                    <pre><span></span><span class="nf">include(</span><span class="nb">AndroidTestUtilities</span><span class="nf">)</span><span class="w"></span>
...
<span class="w">  </span><span class="nf">)</span><span class="w"></span>
                ...
                <p>
                  At build time a test named “example_setup_test” will be
                  created. Run this test on the command line with
                  ...
                  ><a
                    ...
                    ></a
                  >
                  to load the data onto the Android device.
                </p>
              </div>
              <div class="section" id="module-functions">
                ...
                <dl class="command">
                  <dt id="command:android_add_test_data">
                    <code class="sig-name descname">android_add_test_data</code
                    ><a
                      class="headerlink"
                      href="#command:android_add_test_data"
                  ...
                  <dd>
                    <div class="highlight-cmake notranslate">
                      <div class="highlight">
                        <pre><span></span><span class="nf">android_add_test_data(</span><span class="nv">&lt;test-name&gt;</span><span class="w"></span>
...
<span class="w">  </span><span class="nf">)</span><span class="w"></span>
                    ...
                    <p>
                      ...
                      <code class="docutils literal notranslate"
                        ><span class="pre">android_add_test_data</span></code
                      >
                      function is used to copy files and libraries needed to run
                      project-specific tests. On the host operating system, this
                      is done at build time. For on-device testing, the files
                      are loaded onto the device by the manufactured test at run
                      time.
                    </p>
                    ...
                    <dl class="simple">
                      ...
                      <dd><p>zero or more files needed for testing</p></dd>
                      <dt>
                        <code class="docutils literal notranslate"
                          ><span class="pre">LIBS</span>
                          <span class="pre">&lt;libs&gt;...</span></code
                        >
                      </dt>
                      <dd><p>zero or more libraries needed for testing</p></dd>
                      <dt>
                        <code class="docutils literal notranslate"
                          ><span class="pre">FILES_DEST</span>
                          <span class="pre">&lt;device-dir&gt;</span></code
                        >
                      </dt>
                      <dd>
                        <p>
                      ...
                      <dt>
                        <code class="docutils literal notranslate"
                          ><span class="pre">DEVICE_OBJECT_STORE</span>
                          <span class="pre">&lt;device-dir&gt;</span></code
                        >
                      </dt>
                      <dd>
                      ...
                      <dt>
                        <code class="docutils literal notranslate"
                          ><span class="pre">DEVICE_TEST_DIR</span>
                          <span class="pre">&lt;device-dir&gt;</span></code
                        >
                      </dt>
                      <dd>
                        <p>
                          absolute path to the root directory of the on-device
                          test location
                        </p>
                      </dd>
                      <dt>
                        <code class="docutils literal notranslate"
                          ><span class="pre">NO_LINK_REGEX</span>
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <ul>
            <li>
              <a class="reference internal" href="#">AndroidTestUtilities</a>
              <ul>
                <li>
          ...
          <p class="topless">
            <a href="AddFileDependencies.html" title="previous chapter"
              >AddFileDependencies</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="BundleUtilities.html" title="next chapter"
              >BundleUtilities</a
            >
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/AndroidTestUtilities.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="BundleUtilities.html" title="BundleUtilities">next</a> |
        </li>
        <li class="right">
