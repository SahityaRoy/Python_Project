...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgText &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgUtil.html" title="FindosgUtil" accesskey="N">next</a>
          |
        </li>
        <li class="right">
          <a href="FindosgTerrain.html" title="FindosgTerrain" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgtext">
              <span id="module:FindosgText"></span>
              <h1>
                FindosgText<a
                  class="headerlink"
                  href="#findosgtext"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgTerrain.html" title="previous chapter"
              >FindosgTerrain</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgUtil.html" title="next chapter">FindosgUtil</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindosgText.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgUtil.html" title="FindosgUtil">next</a> |
        </li>
        <li class="right">
          <a href="FindosgTerrain.html" title="FindosgTerrain">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
