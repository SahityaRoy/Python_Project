...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgIntrospection &mdash; CMake 3.18.4 Documentation</title>
    ...
    <link
      rel="next"
      title="FindosgManipulator"
      href="FindosgManipulator.html"
    />
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgGA.html" title="FindosgGA" accesskey="P">previous</a>
          |
        </li>
        <li>
          <img
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgintrospection">
              <span id="module:FindosgIntrospection"></span>
              <h1>
                FindosgIntrospection<a
                  class="headerlink"
                  href="#findosgintrospection"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgGA.html" title="previous chapter">FindosgGA</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgManipulator.html" title="next chapter"
          ...
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindosgIntrospection.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgManipulator.html" title="FindosgManipulator">next</a>
          |
        </li>
        <li class="right">
          <a href="FindosgGA.html" title="FindosgGA">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
