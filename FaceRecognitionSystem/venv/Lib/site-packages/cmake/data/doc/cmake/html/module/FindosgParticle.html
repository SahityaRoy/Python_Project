...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgParticle &mdash; CMake 3.18.4 Documentation</title>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgparticle">
              <span id="module:FindosgParticle"></span>
              <h1>
                FindosgParticle<a
                  class="headerlink"
                  href="#findosgparticle"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgManipulator.html" title="previous chapter"
              >FindosgManipulator</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgPresentation.html" title="next chapter"
          ...
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindosgParticle.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
