...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgGA &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgFX.html" title="FindosgFX" accesskey="P">previous</a>
          |
        </li>
        <li>
          <img
    ...
    <div class="document">
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgFX.html" title="previous chapter">FindosgFX</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgIntrospection.html" title="next chapter"
          ...
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindosgGA.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgFX.html" title="FindosgFX">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
