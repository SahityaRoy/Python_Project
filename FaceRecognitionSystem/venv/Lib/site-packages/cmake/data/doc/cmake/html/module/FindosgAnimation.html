...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgAnimation &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgDB.html" title="FindosgDB" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a href="FindOpenThreads.html" title="FindOpenThreads" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosganimation">
              <span id="module:FindosgAnimation"></span>
              <h1>
                FindosgAnimation<a
                  class="headerlink"
                  href="#findosganimation"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindOpenThreads.html" title="previous chapter"
              >FindOpenThreads</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgDB.html" title="next chapter">FindosgDB</a>
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindosgAnimation.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgDB.html" title="FindosgDB">next</a> |
        </li>
        <li class="right">
          <a href="FindOpenThreads.html" title="FindOpenThreads">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
