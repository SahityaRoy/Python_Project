...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindSDL_sound &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindSDL_ttf.html" title="FindSDL_ttf" accesskey="N">next</a>
          |
        </li>
        <li class="right">
          <a href="FindSDL.html" title="FindSDL" accesskey="P">previous</a> |
        </li>
        <li>
          <img
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findsdl-sound">
              <span id="module:FindSDL_sound"></span>
              <h1>
                FindSDL_sound<a
                  class="headerlink"
                  href="#findsdl-sound"
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>SDL_SOUND_INCLUDE_DIR, where to find SDL_sound.h
...
SDL_SOUND_VERSION_STRING, human-readable string containing the
  version of SDL_sound
              ...
              <div class="highlight-none notranslate">
                <div class="highlight">
                  <pre><span></span>SDL_SOUND_LIBRARY, the name of just the SDL_sound library you would link
...
SPEEX_LIBRARY
              ...
              <p>
                ...
                and the other audio libraries (if needed) to successfully
              ...
              <p>
                ...
                as Ogg Vorbis, SMPEG, ModPlug, MikMod, FLAC, Speex, and
                ...
                fails, it parses the error output for known symbol names to
                figure out which libraries are needed.
              </p>
              <p>
                Responds to the $SDLDIR and $SDLSOUNDDIR environmental variable
                that would correspond to the ./configure –prefix=$SDLDIR used in
                building SDL.
              </p>
              <p>
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindSDL.html" title="previous chapter">FindSDL</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindSDL_ttf.html" title="next chapter">FindSDL_ttf</a>
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindSDL_sound.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindSDL_ttf.html" title="FindSDL_ttf">next</a> |
        </li>
        <li class="right">
          <a href="FindSDL.html" title="FindSDL">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
