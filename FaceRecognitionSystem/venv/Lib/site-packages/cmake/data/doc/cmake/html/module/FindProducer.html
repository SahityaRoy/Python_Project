...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindProducer &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindProtobuf.html" title="FindProtobuf" accesskey="N"
            >next</a
          >
          |
        </li>
        <li class="right">
          <a href="FindPostgreSQL.html" title="FindPostgreSQL" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findproducer">
              <span id="module:FindProducer"></span>
              <h1>
                FindProducer<a
                  class="headerlink"
                  href="#findproducer"
              ...
              <p>
                ...
                suite used to find OpenSceneGraph components. You’ll notice that
                I accept OSGDIR as an environment path.
              </p>
              <p>
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindPostgreSQL.html" title="previous chapter"
              >FindPostgreSQL</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindProtobuf.html" title="next chapter">FindProtobuf</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindProducer.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindProtobuf.html" title="FindProtobuf">next</a> |
        </li>
        <li class="right">
          <a href="FindPostgreSQL.html" title="FindPostgreSQL">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
