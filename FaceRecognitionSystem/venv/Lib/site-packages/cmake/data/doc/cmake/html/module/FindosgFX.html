...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgFX &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgGA.html" title="FindosgGA" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a
    ...
    <div class="document">
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="Findosg_functions.html" title="previous chapter"
              >Findosg_functions</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgGA.html" title="next chapter">FindosgGA</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindosgFX.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgGA.html" title="FindosgGA">next</a> |
        </li>
        <li class="right">
