...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgShadow &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgSim.html" title="FindosgSim" accesskey="N">next</a> |
        </li>
        <li class="right">
          <a href="Findosg.html" title="Findosg" accesskey="P">previous</a> |
        </li>
        <li>
          <img
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgshadow">
              <span id="module:FindosgShadow"></span>
              <h1>
                FindosgShadow<a
                  class="headerlink"
                  href="#findosgshadow"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="Findosg.html" title="previous chapter">Findosg</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgSim.html" title="next chapter">FindosgSim</a>
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindosgShadow.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgSim.html" title="FindosgSim">next</a> |
        </li>
        <li class="right">
          <a href="Findosg.html" title="Findosg">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
