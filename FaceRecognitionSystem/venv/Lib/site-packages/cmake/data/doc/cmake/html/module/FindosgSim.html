...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgSim &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgTerrain.html" title="FindosgTerrain" accesskey="N"
            >next</a
          >
          |
        </li>
        <li class="right">
          <a href="FindosgShadow.html" title="FindosgShadow" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgsim">
              <span id="module:FindosgSim"></span>
              <h1>
                FindosgSim<a
                  class="headerlink"
                  href="#findosgsim"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgShadow.html" title="previous chapter"
              >FindosgShadow</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgTerrain.html" title="next chapter"
              >FindosgTerrain</a
            >
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindosgSim.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgTerrain.html" title="FindosgTerrain">next</a> |
        </li>
        <li class="right">
          <a href="FindosgShadow.html" title="FindosgShadow">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
