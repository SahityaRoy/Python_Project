...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgUtil &mdash; CMake 3.18.4 Documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgViewer.html" title="FindosgViewer" accesskey="N"
            >next</a
          >
          |
        </li>
        <li class="right">
          <a href="FindosgText.html" title="FindosgText" accesskey="P"
            >previous</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgutil">
              <span id="module:FindosgUtil"></span>
              <h1>
                FindosgUtil<a
                  class="headerlink"
                  href="#findosgutil"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgText.html" title="previous chapter">FindosgText</a>
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgViewer.html" title="next chapter">FindosgViewer</a>
          </p>
          <div role="note" aria-label="source link">
            <h3>This Page</h3>
            <ul class="this-page-menu">
              <li>
                <a href="../_sources/module/FindosgUtil.rst.txt" rel="nofollow"
                  >Show Source</a
                >
              </li>
            </ul>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgViewer.html" title="FindosgViewer">next</a> |
        </li>
        <li class="right">
          <a href="FindosgText.html" title="FindosgText">previous</a> |
        </li>
        <li>
          <img
            src="../_static/cmake-logo-16.png"
