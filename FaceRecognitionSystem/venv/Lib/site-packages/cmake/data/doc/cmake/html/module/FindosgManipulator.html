...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FindosgManipulator &mdash; CMake 3.18.4 Documentation</title>
    ...
    <link
      rel="prev"
      title="FindosgIntrospection"
      href="FindosgIntrospection.html"
    />
  </head>
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgParticle.html" title="FindosgParticle" accesskey="N"
            >next</a
          >
          |
        </li>
    ...
    <div class="document">
        ...
        <div class="bodywrapper">
          <div class="body" role="main">
            <div class="section" id="findosgmanipulator">
              <span id="module:FindosgManipulator"></span>
              <h1>
                FindosgManipulator<a
                  class="headerlink"
                  href="#findosgmanipulator"
      ...
      <div class="sphinxsidebar" role="navigation" aria-label="main navigation">
        <div class="sphinxsidebarwrapper">
          ...
          <p class="topless">
            <a href="FindosgIntrospection.html" title="previous chapter"
              >FindosgIntrospection</a
            >
          </p>
          <h4>Next topic</h4>
          <p class="topless">
            <a href="FindosgParticle.html" title="next chapter"
              >FindosgParticle</a
            >
          </p>
          <div role="note" aria-label="source link">
            ...
            <ul class="this-page-menu">
              <li>
                <a
                  href="../_sources/module/FindosgManipulator.rst.txt"
                  rel="nofollow"
                  >Show Source</a
                >
              </li>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right">
          <a href="FindosgParticle.html" title="FindosgParticle">next</a> |
        </li>
        <li class="right">
